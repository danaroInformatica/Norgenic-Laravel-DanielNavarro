...
<html lang="es">
    <head>
        ...
        <title>Web Norgenic by Daniel Navarro</title>
        <!-- Favicon-->
        ...
        <link href="{{ url('../theme/startbootstrap-freelancer-gh-pages/css/styles.css') }}" rel="stylesheet" />
        <link href="{{ url('../resources/css/app.css') }}" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        <nav class="header navbar navbar-expand-lg bg-secondary text-uppercase" id="mainNav">
            <div class="container">
